...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    static WDSimpleHTTPRequest * request;
    request = [[WDSimpleHTTPRequest alloc]initWithURL:[NSURL URLWithString:@"www.baidu.com"]];
    [request start];
    
    
  [WDAudioStreamer setOptions:[WDAudioStreamer options] | WDAudioStreamerRequireSHA256];
