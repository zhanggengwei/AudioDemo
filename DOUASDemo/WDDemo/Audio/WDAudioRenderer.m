...
@implementation WDAudioRenderer
                                   ...
                                   AudioBufferList *ioData)
{
  ...
  __unsafe_unretained WDAudioRenderer *renderer = (__bridge WDAudioRenderer *)inRefCon;
  ...
  if (analyzers != nil) {
    for (WDAudioAnalyzer *analyzer in analyzers) {
...
- (BOOL)setUp
{
  ...
  AudioStreamBasicDescription requestedDesc = [WDAudioDecoder defaultOutputFormat];
...
static OSStatus property_listener_default_output_device(AudioObjectID inObjectID,
                                                        ...
                                                        void *inClientData)
{
  __unsafe_unretained WDAudioRenderer *renderer = (__bridge WDAudioRenderer *)inClientData;
