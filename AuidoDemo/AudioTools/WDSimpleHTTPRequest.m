...
@interface WDSimpleHTTPRequest () {
@private
    WDSimpleHTTPRequestCompletedBlock _completedBlock;
    WDSimpleHTTPRequestProgressBlock _progressBlock;
    WDSimpleHTTPRequestDidReceiveResponseBlock _didReceiveResponseBlock;
    WDSimpleHTTPRequestDidReceiveDataBlock _didReceiveDataBlock;
...
@implementation WDSimpleHTTPRequest
...
{
    @autoreleasepool {
        __unsafe_unretained WDSimpleHTTPRequest *request = (__bridge WDSimpleHTTPRequest *)clientCallBackInfo;
...
- (void)cancel
{
    ...
    CFRunLoopPerformBlock(controller_get_runloop(), kCFRunLoopDefaultMode, ^{
        @autoreleasepool {
            [(__bridge WDSimpleHTTPRequest *)__request _closeResponseStream];
